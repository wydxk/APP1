        ...
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="${pageContext.request.contextPath }/BackendUser/dologin" class="site_title"><i class="fa fa-paw"></i> <span>APP BMS</span></a>
            </div>
            ...
            <div class="profile">
              ...
              <div class="profile_info">
                <span>Welcome,</span>
                <h2>${BACKENDUSER_SESSION.userCode }</h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <h3>${BACKENDUSER_SESSION.userName }</h3>
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> APP管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${pageContext.request.contextPath }/info/applist">APP审核</a></li>
